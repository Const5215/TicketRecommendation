...
public class TicketMasterAPI {
	...
	private static final String API_KEY = "l1sXAa8EfZVGh10JhipE3C5kVQBbaEMd";
	...
	private List<Item> getItemList(JSONArray events) throws JSONException {
		...
		for (int i=0;i < events.length(); i++) {
			...
			builder.setAddress(getAddress(event)).setImageUrl(getImageUrl(event)).setCategories(getCategories(event));
